...
beta = 2.0
kappa = 0.0
N = 6 #number of augmented states
...
for t in range(0,N_step-1):
    ...
    Xsigmax = VDpol(XsigmaA[0:2,:],XsigmaA[2:4,:],mu,dt)
    ...
    Ysigma = measure(Xsigmax,XsigmaA[4:6,:])
